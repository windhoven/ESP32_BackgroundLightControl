...
# BackgroundLightControl sourcecode
An Arduino sketch for an ESP32 to conrol the LEDstrips above the modeltrain layout.

Used hardware:
- ESP32 NodeMCU-32S
- I2S ADC (only used in party mode)
- LEDstrip with a dataline for RGB and separate CW and WW.

Todo:
- Needs a better way to get the Fast Clock data from the Marklin CS3.
